        ...
        <div class="col-md-6 col-lg-12 col-xlg-3">
            <div class="card card-hover" style="background-color: transparent">
                <div class="box bg-primary text-center" style="border-radius:10px!important">
                    ...
                    <h5 class="text-white">Data Divisi Keuangan</h5>
                </div>
            </div>
        </div>
    </div>
                          ...
                          <div id="zero_config_wrapper" class="dataTables_wrapper container-fluid dt-bootstrap4">
                              <div class="row">
                                  <div class="col-sm-12 col-md-6">
                                      <a href="{{route('keuangan.create')}}" class="btn btn-success btn-sm">Tambah Keuangan</a>
                                  </div>
                                  <div class="col-sm-12 col-md-6">
                                                  ...
                                                  <tr>
                                                      ...
                                                      <td>
                                                          <div class="card-title m-b-0">
                                                              <form action="{{url('keuangan/'.$user->id)}}" method="post">
                                                                  <div class="btn-group btn-group-justified">
                                                                      <a href="{{url('keuangan/'.$user->id).'/edit'}}"  class="btn btn-warning btn-sm">Edit</a>
                                                                      {{--                                          <a href="{{url('resetpassword/'.$user->id).'/edit'}}"  class="btn btn-primary btn-sm">Reset Password</a>--}}
                                                                      {{csrf_field()}}
                                                                      {{method_field('DELETE')}}
                                                                      <button type="submit" class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yakin ingin menghapus Keuangan?');" >Delete</button>
                                                                  </div>
                                                              </form>
                                                          </div>
                                                      </td>
