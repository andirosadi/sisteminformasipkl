                ...
                <div class="col-md-6 col-lg-4 col-xlg-" >
                    <div class="card card-hover" style="background-color: transparent">
                        <div class="box bg-info text-center" style="border-radius:.40rem!important">
                            ...
                            <h6 class="text-white">Mentor, {{ Auth::user()->name }}</h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 col-xlg-" >
                    <div class="card card-hover" style="background-color: transparent">
                        <div class="box bg-success text-center" style="border-radius:.40rem!important">
                            ...
                            <h6 class="text-white">Total Peserta : {{$totalpesertadivisi}}/{{$kuotadivisi}}</h6>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="accordion" >
                        <div class="card shadow-sm" style=" border-radius:.40rem!important;">
                            <div class="card-header" style="border-top-left-radius:.40rem!important; border-top-right-radius:.40rem!important;background-color: #ffb848">
                            ...
                            <div class="collapse show" aria-labelledby="collapseOne" data-parent="#accordionExample">
                                <ul class="list-style-none scrollable " style="max-height: 64vh" >
                                    @if(count($kuotamentor) == null)
                                        <li class="d-flex no-block card-body border-top">
                                            <div>
                                                <a class="m-b-0 font-medium p-0">Tidak ada updates</a>
                                            </div>
                                        </li>
                                    @else
                                    @foreach($kuotamentor as $kuotamentors)
                                            <li class="d-flex no-block card-body border-top">
                                                <i class="fa fa-check-circle w-30px m-t-5"></i>
                                                <div>
                                                    <a href="#" class="m-b-0 font-medium p-0">Kuota {{$kuotamentors->namadivisi}}</a>
                                                    <span class="text-muted">Total kuota {{$kuotamentors->jumlahkuota}} peserta</span>
                                                    <br>
                                                    <badge class="badge badge-danger">{{$kuotamentors->status_kuota}}</badge>
                                                    <br>
                                                    <span class="text-muted">{{\Carbon\Carbon::parse($kuotamentors->created_at)->format('j F Y')}}</span>
                                                </div>
                                            </li>
                                    @endforeach
                                    @endif
                ...
                <div class="col-lg-4">
                    ...
                    <div class="accordion" id="accordionExample" >
                        <div class="card shadow-sm m-b-0" style="border-top-left-radius:.40rem!important; border-top-right-radius:.40rem!important">
                            ...
                            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                                <ul class="list-style-none scrollable " style="max-height: 57vh" >
                                    ...
                                    <li class="d-flex no-block card-body border-top">
                                        <i class="fa fa-check-circle w-30px m-t-5"></i>
                                        <div>
                                            <a href="#" class="m-b-0 font-medium p-0">{{$logbooks->name}}</a>
                                            <span class="text-muted">Uraian: {{$logbooks->uraian}}</span><br>
                                            <span class="text-muted"><i class="m-r-5 mdi mdi-calendar"></i>{{\Carbon\Carbon::parse($logbooks->tanggal)->format('j F Y')}}</span><br>
                                            <span class="text-muted"><i class="m-r-5 mdi mdi-map-marker"></i>{{$logbooks->lokasi}}</span>
                                        </div>
                                        <div class="ml-auto">
                                            <div class="tetx-right">
                                                    <badge class="badge badge-danger">
                                                        @if ($logbooks->status == 0)
                                                            Belum Disetujui
                                                        @endif
                                                    </badge>
                                            </div>
                        ...
                        <!-- Laporan Updates -->
                        <div class="card shadow-sm m-b-0" style=" border-radius:.40rem!important;">
                            <div class="card-header" id="headingTwo" style="background-color: #28b779">
                                <h5 class="mb-0" style="color: white">
                                    <a class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                        <i class="m-r-5 mdi mdi-credit-card-multiple" aria-hidden="true"></i>
                                        <span>Laporan PKL Updates</span>
                                    </a>
                                </h5>
                            </div>
                            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                                <ul class="list-style-none scrollable " style="max-height: 57vh" >
                                    @foreach($laporanpkl as $laporankls)
                                    <li class="d-flex no-block card-body border-top">
                                        <i class="mdi mdi-file-check w-30px m-t-5"></i>
                                        <div>
                                            <a href="#" class="m-b-0 font-medium p-0">{{$laporankls->judul}}</a>
                                            <span class="text-muted"><i class="m-r-5 mdi mdi-account-check"></i>{{$laporankls->name}}</span><br>
                                            <span class="text-muted"><i class="m-r-5 mdi mdi-calendar"></i>{{\Carbon\Carbon::parse($laporankls->updated_at)->diffForHumans()}}</span>
                                        </div>
                                    </li>
                                    @endforeach
                                </ul>
