        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <div class="accordion" id="accordionExample">
                    <div class="card shadow-sm m-b-0" style="border-top-left-radius:10px!important; border-top-right-radius:10px!important">
                    ...
                    <!-- Laporan Updates -->
                    <div class="card shadow-sm m-b-0" style=" border-radius:10px!important;">
                        <div class="card-header" id="headingTwo" style="background-color: #2255a4">
                            <h5 class="mb-0" style="color: white">
            ...
            <div class="col-lg-4">
                ...
                <div class="accordion">
                    <div class="card shadow-sm" style=" border-radius:10px!important;">
                        <div class="card-header" style="border-top-left-radius:10px!important; border-top-right-radius:10px!important;background-color: #ffb848">
                            <h5 class="mb-0" style="color: white">
                                <a data-toggle="collapse" aria-expanded="true">
                                    <i class="m-r-5 mdi mdi-credit-card-multiple" aria-hidden="true"></i>
