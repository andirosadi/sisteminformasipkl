        ...
        <div class="col-md-12">
            <div class="card card-body printableArea">
                ...
                <p class="text-black-50 m-l-5">
                    ...
                    <br/>Email : suralaya@indonesiapower.co.id
                </p>
                <hr>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="fa-pull-left">
                                <p class="text-black-50 m-l-5">
                                    ...
                                    <br/>a.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Permohonan tersebut dapat diterima dan dilaksanakan mulai tanggal 02 Juli 2018 s/d 31 agustus 2018 dengan peserta sebagai berikut:
                                </p>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="fa-pull-left">
                            <p class="text-black-50 m-l-5">
                                ...
                                <br/>e.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Selama melaksanakan PKL di PT. Indonesia Power Unit Pembangkitan Suralaya, calon peserta tidak mendapat fasilitas apapun dan akan mentaati tata tertib yang berlaku.
