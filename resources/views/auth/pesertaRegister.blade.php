            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('peserta.register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label for="emailjurusan" class="col-md-4 col-form-label text-md-right">{{ __('E-Mail Jurusan') }}</label>
                            <div class="col-md-6">
                                <input id="emailjurusan" type="email" class="form-control{{ $errors->has('emailjurusan') ? ' is-invalid' : '' }}" name="emailjurusan" value="{{ old('emailjurusan') }}" required>
                                @if ($errors->has('emailjurusan'))
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $errors->first('emailjurusan') }}</strong>
                                </span>
                                @endif
                            </div>
                        </div>
